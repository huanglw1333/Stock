...
class GUIDemo(Frame):
	...
	def createWidgets(self):
		...
		self.new = Button(self, text = "投信買賣超排行", height = 3, width = 20, command = self.out_text_domestic)
	...
	def out_text_domestic(self):
		all_data = buyNsell.main_proc("domestic")
		window1 = Toplevel()
		window1.grid()
		window1.title("投信買賣超列表_集中")
